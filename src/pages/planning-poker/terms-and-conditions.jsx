...
const PrivacyPolicyPage = () => (
  <Layout>
    <Seo title="Planning Poker Online - Terms & Conditions" />
    <section className="py-12 px-4 text-center">
      <h1 className="text-white text-3xl leading-tight font-semibold font-heading">
        Planning Poker Online
      </h1>
      <h2 className="mt-2 text-white text-xl leading-tight font-semibold font-heading">
        Terms & Conditions
      </h2>
      <div className="mt-4 text-white text-justify w-full max-w-2xl mx-auto">
        <div>
          <p className="mt-2">
            ...
            property rights related to it, still belong to Alessio Bianchetti.
          </p>
          <p className="mt-2">
            Alessio Bianchetti is committed to ensuring that the app is as
          ...
          <p className="mt-2">
            ...
            that you have provided to us, in order to provide my Service. It’s
            ...
            mean that the Planning Poker (SCRUM) app won’t work properly or at
            all.
          </p>
          <p className="mt-2">
            You should be aware that there are certain things that Alessio
            Bianchetti will not take responsibility for. Certain functions of
            ...
            provider, but Alessio Bianchetti cannot take responsibility for the
          ...
          <p className="mt-2">
            ...
            you can’t turn it on to avail the Service, Alessio Bianchetti cannot
            accept responsibility.
          </p>
          <p className="mt-2">
            With respect to Alessio Bianchetti’s responsibility for your use of
            the app, when you’re using the app, it’s important to bear in mind
            that although we endeavour to ensure that it is updated and correct
            at all times, we do rely on third parties to provide information to
            us so that we can make it available to you. Alessio Bianchetti
          ...
          <p className="mt-2">
            ...
            you want to keep using the app. Alessio Bianchetti does not promise
