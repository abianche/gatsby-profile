  ...
  <Layout>
    ...
    <section className="py-12 px-4 text-center">
      ...
      <div className="mt-4 text-white text-justify w-full max-w-2xl mx-auto">
        <div>
          <p className="mt-2">
            Alessio Bianchetti built the Planning Poker (SCRUM) app as a Free
            app. This SERVICE is provided by Alessio Bianchetti at no cost and
            ...
            is accessible at Planning Poker (SCRUM) unless otherwise defined in
            this Privacy Policy.
          </p>
          <h2 className="mt-4 font-bold">Information Collection and Use</h2>
          <p className="mt-2">
          ...
          <h2 className="mt-4 font-bold">Log Data</h2>
          <p className="mt-2">
          ...
          <h2 className="mt-4 font-bold">Cookies</h2>
          <p className="mt-2">
          ...
          <h2 className="mt-4 font-bold">Service Providers</h2>I may employ
          ...
          <h2 className="mt-4 font-bold">Links to Other Sites</h2>
          <p className="mt-2">
          ...
          <h2 className="mt-4 font-bold">Children’s Privacy</h2>
          <p className="mt-2">
          ...
          <p className="mt-2">
            ...
            not hesitate to contact me at alessio.bianchetti@gmail.com.
          </p>
        </div>
      </div>
    </section>
